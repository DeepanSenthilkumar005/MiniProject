    ...
    >
      <div className="relative p-4 rounded-2xl">
        ...
        <div className="relative z-10 p-4">
          <h1 className="text-3xl font-bold text-600 text-red-600">
          ...
          <div className="mt-5 gap-4 w-full grid md:flex space-x-4">
            <Link
              to="/schedule"
              className="bg-orange-500 px-4 py-2 text-white rounded w-full"
            >
              View Schedule
            </Link>
            <Link
              to="/routes"
              className="bg-yellow-500 px-4 py-2 text-white rounded w-full"
            >
              Manage Routes
            </Link>
          </div>
